...
const AddRequest = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (!district || !upazila)
      return toast.warning("Please select district and upazila.");
    setSubmitting(true);
    const form = e.target;
    try {
        ...
        >
          <form onSubmit={handleSubmit}>
            ...
            >
              ...
              {/* ✅ FIXED: filter upazilas by matching district name → id */}
              <div>
              ...
              <div style={{ gridColumn: "1 / -1", paddingTop: ".5rem" }}>
                <button
                  type="submit"
                  disabled={submitting || !district || !upazila}
                  style={{
                    padding: ".8rem 2.5rem",
                    borderRadius: 50,
                    border: "none",
                    ...
                    transition: "all .2s",
                    opacity: submitting || !district || !upazila ? 0.65 : 1,
                  }}
                >
